...
if __name__ == "__main__":
    ...
    fc = Flatten()(encoder)
    fc = Dense(4*(1+maxLength), activation='relu')(fc)
    fc = Dense(1+maxLength, activation='sigmoid')(fc)
    model = Model(input=[inputQ, inputC], output=fc)
    model = load_model("NOATTENTIONSIGMOID87.h5", custom_objects={'Attention' : Attention})
